...
class TinyStoryNanoGPTConfig(BaseExperimentConfig): 
    def __init__(self):
        super().__init__()
        self.description = "NanoGPT model trained on TinyStory dataset"
...
class TinyStoryLlamaConfig(BaseExperimentConfig): 
    def __init__(self):
        super().__init__()
        self.description = "LlaMa model trained on TinyStory dataset"
